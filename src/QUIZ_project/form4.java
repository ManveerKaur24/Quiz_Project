...
public class form4 extends JFrame implements ActionListener, ItemListener {
    ...
    public void getdata() throws ClassNotFoundException, SQLException {
        ...
        rs = stmt.executeQuery("SELECT * FROM quant_ques");
    ...
    public class Resultwindow extends JFrame implements ActionListener {
        ...
        Resultwindow() {
            ...
            for (int j = 0; j < 5; j++) {
                ...
                l[j].setText("Ques " + q[j] + ": " + get[j] + " correct ans " + crtans[j]);
